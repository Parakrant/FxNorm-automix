...
from common_losses import Loss, StereoLoss, StereoLoss2
...
config["INPUTS"] = [
    ...
    "drums_normalized",
    "other_normalized",
]  # Must follow names of normalized wav files. e.g.vocals_normalized.wav
...
from common_networkbuilding_cafx_tdcn_lstm_mix import (
    Net,
...
config["DATA_DIR_TRAIN"].append(("/home/u571/work/automix/input/train", False))
...
config["DATA_DIR_VALID"].append(("/home/u571/work/automix/input/train", False))
