...
from automix.common_audioeffects import Panner, Compressor, AugmentationChain, ConvolutionalReverb, Equaliser, AlgorithmicReverb
...
#     loudness_['d_peak'].append(np.abs(peak_tar_db-peak_out_db))
    loudness_['d_lufs'].append(mean_absolute_percentage_error([loudness_tar], [loudness_out]))
    loudness_['d_peak'].append(mean_absolute_percentage_error([peak_tar_db], [peak_out_db]))
...
#         assert np.isnan(std_ro_out).any() == False, f'NAN values out std ro {idx}'
        ...
        mape_mean_sc = mean_absolute_percentage_error(mean_sc_tar[0], mean_sc_out[0])
#         mape_std_sc = mean_absolute_percentage_error(std_sc_tar[0], std_sc_out[0])
        
        mape_mean_bw = mean_absolute_percentage_error(mean_bw_tar[0], mean_bw_out[0])
#         mape_std_bw = mean_absolute_percentage_error(std_bw_tar[0], std_bw_out[0])
        
        mape_mean_ct_l = mean_absolute_percentage_error(mean_ct_tar[0], mean_ct_out[0])
#         mape_std_ct_l = mean_absolute_percentage_error(std_ct_tar[0], std_ct_out[0])
        
        mape_mean_ct_m = mean_absolute_percentage_error(np.mean(mean_ct_tar[1:4], axis=0),
                                                                        np.mean(mean_ct_out[1:4], axis=0))
#         mape_std_ct_m = mean_absolute_percentage_error(np.mean(std_ct_tar[1:4], axis=0),
#                                                                         np.mean(std_ct_out[1:4], axis=0))

        mape_mean_ct_h = mean_absolute_percentage_error(mean_ct_tar[-1], mean_ct_out[-1])
#         mape_std_ct_h = mean_absolute_percentage_error(std_ct_tar[-1], std_ct_out[-1])
   
        mape_mean_ro = mean_absolute_percentage_error(mean_ro_tar[0], mean_ro_out[0])
#         mape_std_ro = mean_absolute_percentage_error(std_ro_tar[0], std_ro_out[0])
        
        mape_mean_ft = mean_absolute_percentage_error(mean_ft_tar[0], mean_ft_out[0])
#         mape_std_ft = mean_absolute_percentage_error(std_ft_tar[0], std_ft_out[0])
...
def compute_panning_features(args_):
    ...
    panning_['P_t_mean'] = [mean_absolute_percentage_error(mean_tar[0], mean_out[0])]
#     panning_['P_t_std'] = [mean_absolute_percentage_error(std_tar[0] + eps, std_out[0])]
    panning_['P_l_mean'] = [mean_absolute_percentage_error(mean_tar[1], mean_out[1])]
#     panning_['P_l_std'] = [mean_absolute_percentage_error(std_tar[1] + eps, std_out[1])]
    panning_['P_m_mean'] = [mean_absolute_percentage_error(mean_tar[2], mean_out[2])]
#     panning_['P_m_std'] = [mean_absolute_percentage_error(std_tar[2] + eps, std_out[2])]
    panning_['P_h_mean'] = [mean_absolute_percentage_error(mean_tar[3], mean_out[3])]
#     panning_['P_h_std'] = [mean_absolute_percentage_error(std_tar[3] + eps, std_out[3])]
...
#     dyn_out = db_to_amp(dyn_out)
    ...
    dynamic_['rms_mean'] = [mean_absolute_percentage_error(mean_rms_tar, mean_rms_out)]
#     dynamic_['rms_std'] = [mean_absolute_percentage_error(std_rms_tar, std_rms_out)]
    dynamic_['dyn_mean'] = [mean_absolute_percentage_error(mean_dyn_tar, mean_dyn_out)]
#     dynamic_['dyn_std'] = [mean_absolute_percentage_error(std_dyn_tar, std_dyn_out)]
    dynamic_['crest_mean'] = [mean_absolute_percentage_error(mean_crest_tar, mean_crest_out)]
#     dynamic_['crest_std'] = [mean_absolute_percentage_error(std_crest_tar, std_crest_out)]
    
    dynamic_['l_ratio_mean_mape'] = [mean_absolute_percentage_error(mean_low_ratio_tar, mean_low_ratio_out)]
    dynamic_['l_ratio_mean_l2'] = [mean_squared_error(mean_low_ratio_tar, mean_low_ratio_out)]
#     dynamic_['l_ratio_std'] = [mean_absolute_percentage_error(std_low_ratio_tar, std_low_ratio_out)]
